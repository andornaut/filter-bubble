...
export const DOMAIN_NAMES_HINT = (
  <div>
    A list of{' '}
    <a href="https://en.wikipedia.org/wiki/Domain_name" target="_blank" rel="noopener noreferrer">
      domain names
    </a>{' '}
    (
    ...
    without the{' '}
    <a href="https://en.wikipedia.org/wiki/List_of_URI_schemes" target="_blank" rel="noopener noreferrer">
      scheme
    </a>{' '}
    or{' '}
    <a href="https://en.wikipedia.org/wiki/URL#Syntax" target="_blank" rel="noopener noreferrer">
      path
    </a>
    ), separated by commas, that target the websites from which to hide or remove the{' '}
    <a href="#topics">topics that you've configured</a>.
    <br />
...
export const CSS_SELECTORS_HINT = (
  <div>
    A list of{' '}
    <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_selectors" target="_blank" rel="noopener noreferrer">
      CSS selectors
    </a>{' '}
