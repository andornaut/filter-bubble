...
export const HELP_HTML = (
  <div className="help__content">
    ...
    <ol>
      <li>
        Create a list of <a href="#topics">topics</a> that you want to hide or
        remove from <a href="#websites">specific websites</a>
      </li>
      ...
      <li>
        ...
        of the content blocks or feed items that might contain any of the
        targeted topics
      </li>

      <li>
        If a targeted topic appears in a targeted HTML element on a targeted
        website, then it'll be hidden or removed from view
      </li>
    </ol>
    <p>
      n.b. Only a handful of{" "}
      <a href="#websites">websites are configured out of the box</a>, and you'll
      need to know how to target{" "}
      <a
        href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element"
        target="_blank"
      >
...
export const DOMAIN_NAMES_HINT = (
  <>
    ...
    ), separated by commas, that target the websites from which to hide or
    remove the <a href="#topics">topics that you've configured</a>.
    <br />
    eg. Specifying "example.com" above will target "http://example.com" and
    "https://example.com/path/?query", etc.
  </>
);
